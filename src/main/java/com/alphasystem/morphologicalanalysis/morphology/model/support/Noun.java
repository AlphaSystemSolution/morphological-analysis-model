...
public enum Noun implements ArabicLetters, NounSupport {
    ...
    FORM_VII_MASCULINE_PASSIVE_PARTICIPLE(createRootWord(2, 3, 4, MEEM_WITH_DAMMA, NOON_WITH_SUKUN, FA_WITH_FATHA, AIN_WITH_FATHA,
            LAM_WITH_DAMMATAN)),

    FORM_VII_FEMININE_PASSIVE_PARTICIPLE(createRootWord(2, 3, 4, MEEM_WITH_DAMMA, NOON_WITH_SUKUN, FA_WITH_FATHA, AIN_WITH_FATHA,
            LAM_WITH_FATHA, TA_MARBUTA_WITH_DAMMATAN), true),
