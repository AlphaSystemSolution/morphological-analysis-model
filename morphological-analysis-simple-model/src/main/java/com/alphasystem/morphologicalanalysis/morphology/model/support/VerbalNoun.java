...
public enum VerbalNoun implements ArabicLetters, NounSupport {
    ...
    VERBAL_NOUN_V16(createRootWord(0, 1, 3, -1, FA_WITH_DAMMA, AIN_WITH_DAMMA, WAW_WITH_SUKUN, LAM_WITH_DAMMATAN)),

    VERBAL_NOUN_V17(createRootWord(0, 1, 3, -1, FA_WITH_FATHA, AIN_WITH_DAMMA, WAW_WITH_SUKUN, LAM_WITH_DAMMATAN)),

    VERBAL_NOUN_V18(createRootWord(0, 1, 3, -1, FA_WITH_FATHA, AIN_WITH_DAMMA, WAW_WITH_SUKUN, LAM_WITH_FATHA,
            TA_MARBUTA_WITH_DAMMATAN), true),
    ...
    VERBAL_NOUN_V22(createRootWord(0, 1, 2, -1, FA_WITH_KASRA, AIN_WITH_SUKUN, LAM_WITH_FATHA, LETTER_ALIF_MAKSURA)),

    VERBAL_NOUN_V23(createRootWord(0, 1, 2, -1, FA_WITH_FATHA, AIN_WITH_SUKUN, LAM_WITH_FATHA, LETTER_ALIF_MAKSURA)),

    VERBAL_NOUN_V24(createRootWord(0, 1, 2, -1, FA_WITH_DAMMA, AIN_WITH_SUKUN, LAM_WITH_FATHA, LETTER_ALIF_MAKSURA)),

    VERBAL_NOUN_V25(createRootWord(0, 1, 2, -1, FA_WITH_FATHA, AIN_WITH_KASRA, YA_WITH_SUKUN, LAM_WITH_DAMMATAN)),
    ...
    VERBAL_NOUN_V28(createRootWord(1, 2, 3, -1, MEEM_WITH_FATHA, FA_WITH_SUKUN, AIN_WITH_KASRA, LAM_WITH_FATHA,
            TA_MARBUTA_WITH_DAMMATAN), true),
