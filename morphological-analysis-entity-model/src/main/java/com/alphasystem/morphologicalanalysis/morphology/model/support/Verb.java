...
public enum Verb implements ArabicLetters, VerbSupport {
    ...
    FORM_X_PAST_PASSIVE_TENSE(createRootWord(3, 4, 5, -1, ALIF_HAMZA_ABOVE_WITH_DAMMA, SEEN_WITH_SUKUN, TA_WITH_DAMMA,
            FA_WITH_SUKUN, AIN_WITH_KASRA, LAM_WITH_FATHA)),

    FORM_X_PRESENT_PASSIVE_TENSE(createRootWord(3, 4, 5, -1, YA_WITH_DAMMA, SEEN_WITH_SUKUN, TA_WITH_FATHA, FA_WITH_SUKUN,
            AIN_WITH_FATHA, LAM_WITH_DAMMA)),
